...
import BlendHeaderCreationView from "./BlendHeaderCreationView"
import { generateTeas } from "@/lib/utils"
import { Tea, BlendAllocation } from "./types"

type ActiveView = 'purchasing' | 'allocation' | 'dashboard' | 'blend Creation';
...
export default function TeaBlendAllocation() {
  ...
  return (
    <div className="flex h-screen">
      ...
      {activeView === 'blend Creation' && <BlendHeaderCreationView />}
